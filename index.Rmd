...
The following plots show the raw data for the three central lake monitoring stations and parameters, 1993 - 2021.  Select the station, parameter, and plot type (total time series, by year, or by month).  The year and month plots are aggregated box plots of all observations at a station for each selected time period.
