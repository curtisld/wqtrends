...
epi_hyp_lake_samm_nointerp <- function(data=data,parm='Temperature',lake='Sammamish',station='0612',yrstart=1993,yrend=2018){
  
  # volume weighting fractions for each meter depth for deepest lake station    
  vol_frac <- read_excel('//kc.kingcounty.lcl/dnrp/WLRD/STS/Share/!CSOWQA/Lake Washington/Data/water/R/Copy of Sammamish-depth-volume2.xls','Isaac 1966')  
